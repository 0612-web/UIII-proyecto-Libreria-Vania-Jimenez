...
# Esto le dice a Django: "Busca archivos también en la carpeta static de la raíz"
STATICFILES_DIRS = [
    BASE_DIR / 'static',
]
...
TEMPLATES = [
    {
        ...
        # Agregamos la ruta explícita para asegurar que encuentre los archivos
